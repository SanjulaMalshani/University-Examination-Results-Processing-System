...
import { vcClickCollectionView, vcClickResultApprovalBtn } from '../../store/reducers/VCNavigationSlice';
...
function VCResultSheetsCollection() {
  ...
  console.log(resultsSheets);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`${host}/api/results/vc/collection/${personId}/${pendingSheetId}`, updatedSheet, {
                headers: {
...
export default VCResultSheetsCollection
