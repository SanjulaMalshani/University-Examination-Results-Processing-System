...
function SideNavBar({ userType }) {
    ...
    useEffect(() => {
        if(location.pathname.includes('/add-result')){
            setActiveLink('Add Results')
        }
        if(location.pathname.includes('/result-sheets')){
            setActiveLink('Approve Pending Results')
        }
        if(location.pathname.includes('/approved-result-sheets')){
    ...
    const handleNavLinkClick = (name) => {
        ...
        if (userType === 'lecture') {
            ...
            if(name === 'Add Results'){
                return navigate("/lecture/add-result")
            }
            if(name === "Approve Pending Results"){
                return navigate("/lecture/result-sheets")
            }
            if(name === "History"){
                return navigate("/lecture/approved-result-sheets")
            }
