...
function RegistarResultCollectionResult() { 
    ...
    const pendingSheetId = useSelector((store) => store.registarNavigationSlice?.pendingRTSheetId);
    const resultsSheets = useSelector((store) => store.registarNavigationSlice?.studentCollectionItemResultsSheetsRT || []);
