...
function DeanResult() {
    ...
    const resultsSheets = useSelector((store) => store.deanNavigationSlice.resultsSheets || []);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`${host}/api/results/dean/${personId}/${pendingSheetId}`, updatedSheet, {
                headers: {
