...
const lectureNavigationSlice = createSlice({
    ...
    reducers: {
        ...
        setDetails: (state, action) => {
            ...
            const { facultyName, departmentName, degreeName,  batchName, semesterName, subjectName, subjectCode,selectedDate,subjectCredit, secondMarker } = action.payload;
            ...
            state.secondMarker = secondMarker;
        },
